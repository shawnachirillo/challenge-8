  ...
  createVehicle(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.vehicleType === 'Truck') this.createTruck();
        if (answers.vehicleType === 'Motorbike') this.createMotorbike();
      });
  }
      ...
      .then((answers) => {
        ...
        switch (answers.action) {
          ...
          case 'Tow another vehicle':
            if (selected instanceof Truck) {
              this.findVehicleToTow(selected);
              return;
            } else {
            ...
            break;
          case 'Wheelie':
            if (selected instanceof Motorbike) {
              selected.wheelie();
            } else {
